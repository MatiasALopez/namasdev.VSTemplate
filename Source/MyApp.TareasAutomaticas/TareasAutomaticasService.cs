...
{
    public class TareasAutomaticasService : IHostedService
    {
        ...
        public Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            _tiempoEsperaEjecucion = TimeSpan.FromMinutes(int.Parse(ConfigurationManager.AppSettings["TiempoEsperaEjecucionEnMin"]));
